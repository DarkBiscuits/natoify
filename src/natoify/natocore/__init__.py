"""
The Natocore package contains modules for converting plain text messages into their
...
decrypting messages. A command line interface and customtkinter desktop app is also 
